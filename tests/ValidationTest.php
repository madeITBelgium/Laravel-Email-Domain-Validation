...
class validateTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testValidEmailNotAllowedFails()
    {
        ...
        $translator->shouldReceive('trans')->once()->with('validation.custom')->andReturn('validation.custom');
        $translator->shouldReceive('trans')->once()->with('validation.custom.foo.domainnot')->andReturn('validation.custom.foo.domainnot');
        $translator->shouldReceive('trans')->once()->with('validation.domainnot')->andReturn('validation.domainnot');
        $translator->shouldReceive('trans')->once()->with('validation.attributes')->andReturn('validation.attributes');
        $factory = new Factory($translator, $container);
        $factory->extend('domainnot', 'MadeITBelgium\EmailDomainValidation\Validation\ValidatorExtensions@validateDomainnot', 'The domain of :attribute is not allowed');
